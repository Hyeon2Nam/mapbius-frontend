import KakaoMap from "./Maptest";
import { useCallback, useEffect, useMemo, useRef, useState, ReactDOM } from "react";
import { Map, useMap, MarkerTrackerStyle, AbstractOverlay } from "react-kakao-maps"; // Ensure correct library import
...
const TooltipMarker = () => {
  ...
  return (
    <Map
      ...
      level={3}
    >
      {/* Marker and TooltipMarker logic */}
    </Map>
  );
};
